...
When the task involves OTEL, OTLP, traces, observability backends, or telemetry-driven analysis, also read and follow `.github/aw/token-optimization-observability.md` after loading the matching workflow prompt or skill.
